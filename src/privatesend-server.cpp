...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Xnz related functionality
...
/*
    ...
    allow endless transaction that would bloat Xnz and make it unusable. To

    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Xnz Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Xnz Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  xnz-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Xnz in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XNZ, 0.1 XNZ, 1 XNZ and 10 XNZ -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://xnzpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://xnzpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Xnz Core is shutting down...") + "<br /><br />" +

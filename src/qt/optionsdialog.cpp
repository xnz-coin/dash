    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("XNZ-light"), QVariant("light"));
    ui->theme->addItem(QString("XNZ-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("XNZ-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("XNZ-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("XNZ-traditional"), QVariant("trad"));

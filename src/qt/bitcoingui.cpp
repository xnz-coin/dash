    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Xnz Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Xnz address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xnz: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Xnz Core"), this);
    aboutAction->setStatusTip(tr("Show information about Xnz Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Xnz Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Xnz addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Xnz addresses"));
    ...
    openAction->setStatusTip(tr("Open a xnz: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Xnz Core help message to get a list with possible Xnz Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Xnz Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Xnz network", "", count));
    } else {
...
{
    QString strTitle = tr("Xnz Core"); // default title

...
<context>
    ...
    <message>
        <source>To use xnz, or the -server option to dash-qt, you must set an rpcpassword in the configuration file:
%s
...
for example: alertnotify=echo %%s | mail -s "Dash Alert" admin@foo.com
        ...
        <translation>Para usar xnz, o la opción -server de dash-qt, debe establecer rpcpassword en el archivo de configuración:
%s

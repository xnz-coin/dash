...
```
  ...
  --nocleanup           Leave xnzs and test.* datadir on exit or error
  --noshutdown          Don't stop xnzs after the test execution
  --srcdir=SRCDIR       Source directory containing xnz/dash-cli
                        (default: ../../src)

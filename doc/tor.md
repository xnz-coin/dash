...
port 9050 and only allows .onion nodes to connect:
	...
	./xnz -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion

In a typical situation, this suffices to run behind a Tor proxy:

	./xnz -proxy=127.0.0.1:9050
...
your xnz's P2P listen port (9999 by default).
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./xnz -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./xnz -onion=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -discover
